...
i3lock -kef -c "$bspwm_theme_primary_color"ff \
       ...
       --ring-color="$bspwm_theme_secondary_color"ff \
       --ringver-color="$bspwm_theme_secondary_color"ff \
       --insidever-color=00000000  \
       --ringwrong-color="$bspwm_theme_secondary_color"ff \
       --insidewrong-color=00000000 \
       --keyhl-color="$bspwm_theme_primary_color"ff  \
       --bshl-color="$bspwm_theme_primary_color"ff \
       ...
       --time-size=75 \
       --date-size=18  \
       --verif-color="$bspwm_theme_secondary_color"ff \
       --greeter-color="$bspwm_theme_secondary_color"ff  \
       --time-color="$bspwm_theme_secondary_color"ff \
       --wrong-color="$bspwm_theme_secondary_color"ff  \
       --date-color="$bspwm_theme_secondary_color"ff \
