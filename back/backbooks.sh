...
|| echo -e "\033[31mWARNING: Failure to read TBR count!"
echo added $(calc "$postcount_2023 - $precount_2023") to Read 2023 "for a total of $postcount_2023" \
|| echo -e "\033[31mWARNING: Failure to read 2023 count!"
echo added $(calc "$postcount_2022 - $precount_2022") to Read 2022 "for a total of $postcount_2022" \
|| echo -e "\033[31mWARNING: Failure to read 2022 count!"
echo added $(calc "$postcount_2021 - $precount_2021") to Read 2021 "for a total of $postcount_2021" \
|| echo -e "\033[31mWARNING: Failure to read 2021 count!"
echo added $(calc "$postcount_2020 - $precount_2020") to Read 2020 "for a total of $postcount_2020" \
|| echo -e "\033[31mWARNING: Failure to read 2020 count!"
echo added $(calc "$postcount_2019 - $precount_2019") to Pre-2019 "for a total of $postcount_2019" \
|| echo -e "\033[31mWARNING: Failure to read 2019 count!"
echo "for a grand total of" $(calc "$postcount_tbr + $postcount_2023 + $postcount_2022 + $postcount_2021 + $postcount_2020 + $postcount_2019") \
"(double check: $(fd 'pdf|epub|mobi' ~/Books | wc -l))" \
|| echo -e "\033[31mWARNING: Failure to read total count!"

echo ""
echo ":: Booklist backed successfully! Committing to git..."
cd ~/Misc/Backups/my-books/ || echo -e "\033[31mWARNING: Failure to go to backup directory!" || exit
