...
precount_2024=$(cat ~/Misc/Backups/ebook-library/read-2024.txt  | wc -l)
...
ls -1 ~/Books/xdone/2024 > ~/Misc/Backups/ebook-library/read-2024.txt && echo ":: Read 2024 success!" 
ls -1 ~/Books/xdone/2023 > ~/Misc/Backups/ebook-library/read-2023.txt && echo ":: Read 2023 success!" 
ls -1 ~/Books/xdone/2022 > ~/Misc/Backups/ebook-library/read-2022.txt && echo ":: Read 2022 success!" 
ls -1 ~/Books/xdone/2021 > ~/Misc/Backups/ebook-library/read-2021.txt && echo ":: Read 2021 success!" 
ls -1 ~/Books/xdone/2020 > ~/Misc/Backups/ebook-library/read-2020.txt && echo ":: Read 2020 success!" 
ls -1 ~/Books/xdone/2019-and-before > ~/Misc/Backups/ebook-library/pre-2019.txt && echo ":: Pre-2019 success!" 
...
postcount_2024=$(cat ~/Misc/Backups/ebook-library/read-2024.txt  | wc -l)
...
diff_2024=$(("$postcount_2024"-"$precount_2024"))
...
grand_total=$(("$postcount_tbr"+"$postcount_2024"+"$postcount_2023"+"$postcount_2022"+"$postcount_2021"+"$postcount_2020"+"$postcount_2019"+"$postcount_fix"))
double_check="$(fd 'pdf|epub|mobi|djvu' ~/Books | sed '/add\//d' | wc -l)"

[ $diff_2024 -eq 0 ] || diff_2024="\033[31m$diff_2024\033[0m" 
...
echo ""
echo -e "added $diff_2024 to Read 2024 for a total of \033[4;31m$postcount_2024\033[0m" \
|| echo -e "\033[33mWARNING: Failure to read 2024 count!\033[0m"
echo -e "added $diff_2023 to Read 2023 for a total of \033[31m$postcount_2023\033[0m" \
